/// @file UnitPositionTypeConverter.cs
...
namespace Tizen.NUI.FLUX
{
    ...
    /// </code>
    public class UnitPositionTypeConverter : Binding.TypeConverter
    {
        /// <summary>
        /// class for converting unit position in XMAL
        /// </summary>
        ...
        public override object ConvertFromInvariantString(string value)
        {
            if (value != null)
            {
                ...
                if (parts.Length == 2)
                {
                    return new UnitPosition(Int32.Parse(parts[0].Trim(), CultureInfo.InvariantCulture),
                                    Int32.Parse(parts[1].Trim(), CultureInfo.InvariantCulture));
                }
            }

            throw new InvalidOperationException($"Cannot convert \"{value}\" into {typeof(UnitPosition)}");
        }
    }    
}